...
Partial Public NotInheritable Class CoCoCo_Invoicing
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _CoCoCo_Invoicing As CoCoCo_Invoicing
    ...
    Friend Shared Property CoCoCo_Invoicing() As CoCoCo_Invoicing
        Get
            Return _CoCoCo_Invoicing
        End Get
        Set
            If (_CoCoCo_Invoicing Is Nothing) Then
                _CoCoCo_Invoicing = value
            Else
